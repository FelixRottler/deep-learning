...
class DQNNetwork(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(input_dim[0], num_filters[0], filter_sizes[0], stride=4)
        ...
        self.fc1 = torch.nn.Linear(num_filters[2] * 9 * 9, fc_hidden_dim)
...
class ToTensor(object):
    def __call__(self, sample):
        return torch.tensor(sample / 255.0)
...
class DQNAgent:
    def __init__(
        ...
        self.q_eval = DQNNetwork(
            input_dim=input_dim, action_dim=number_actions, batch_size=batch_size
        ...
        self.batch_size = batch_size
        self.memory = ReplayBuffer(self.input_dim, memory_capacity, batch_size)
    ...
    def learn(self):
        ...
        with torch.no_grad():
            ...
            next_predictions = self.q_target.forward(next_state_batch)[
                batch_index, target_actions
            ]
